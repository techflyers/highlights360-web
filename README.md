...
<img src="./screenshots/sceenshot.png" alt="Main Tab" height="450" width="202">
...
1. **Install & Build the npm App:**
    * **Prerequisites:**
      * Ensure [Node.js](https://nodejs.org/) (v14 or higher) is installed.
      * Verify by running `node -v` and `npm -v` in the terminal.
